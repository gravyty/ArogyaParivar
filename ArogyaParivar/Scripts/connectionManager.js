var connectionManager = function () {
    ...
    var _signaler,
        _connections = {},
        _iceServers = [{ url: 'stun:217.10.68.152:19302' }], // stun.l.google.com - Firefox does not support DNS names.
        ...
        _initialize = function (signaler, onReadyForStream, onStreamAdded, onStreamRemoved) {
            _signaler = signaler;
			console.log('iniialize connection manageer');
            ...
            connection.setRemoteDescription(new RTCSessionDescription(sdp), function () {
                if (connection.remoteDescription.type == "offer") {
                    ...
                    connection.createAnswer(function (desc) {
                            ...
                            },function (error) { console.log('Error setting local description: ' + error);},constraints);
                    },
                    function (error) { console.log('Error creating session description: ' + error); });
                } else if (connection.remoteDescription.type == "answer") {
                    console.log('WebRTC: received answer');
                }
            },function (error) { console.log('Error setting remote description: ' + error);})
        },
        ...
        _receivedCandidateSignal = function (connection, partnerClientId, candidate) {
			...
			console.log('WebRTC: candidate signal processed');
        },
...
console.log(_connections[partnerClientId]);
...
console.log('initiate offer');
            ...
            connection.createOffer(function (desc) {
                connection.setLocalDescription(desc, function () {
                    _signaler.sendSignal(JSON.stringify({ "sdp": connection.localDescription }), partnerClientId);
                },function (error) { console.log('Error setting description: ' + error)});
            }, function (error) { console.log('Error creating session description: ' + error); },constraints);
        };
